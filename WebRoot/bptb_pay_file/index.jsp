<%
	/* *
	 *功能：支付宝批量付款到银行账户-上传付款文件无密接口调试入口页面
	 *版本：3.3
	 *日期：2012-08-17
	 *说明：
...
<html>
	<head>
	<title>支付宝批量付款到银行账户-上传付款文件无密接口</title>
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝批量付款到银行账户-上传付款文件无密接口快速通道</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd><span class="null-star">*</span>
						<input size="30" name="WIDbptb_pay_file" />
						<span>请填写完整的文件路径，如：D:\java\alipay\20120817_0001.csv</span>
					</dd>
                    <dt></dt>
                    <dd>
