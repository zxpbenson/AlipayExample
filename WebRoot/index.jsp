...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
    <a target="_blank" href="alipay.batchpay.bptb.detail.query">alipay.batchpay.bptb.detail.query</a></br>
    <a target="_blank" href="batch_trans_notify">batch_trans_notify</a></br>
    ...
    <a target="_blank" href="query_timestamp">query_timestamp</a></br>
</body>
</html>