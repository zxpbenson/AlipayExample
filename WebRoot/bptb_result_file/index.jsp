<%
	/* *
	 *功能：支付宝批量付款到银行账户-下载付款结果文件接口调试入口页面
	 *版本：3.3
	 *日期：2012-08-17
	 *说明：
...
<html>
	<head>
	<title>支付宝批量付款到银行账户-下载付款结果文件接口</title>
...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝批量付款到银行账户-下载付款结果文件接口快速通道</span>
		</div>
        ...
        <form name=alipayment action=alipayapi.jsp method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDdate" />
						<span>格式为：YYYYmmdd</span>
					</dd>
                    <dt></dt>
                    <dd>
