...
<%
	...
	String path = FileLogger.getLogFilePath("batch_trans_notify_no_pwd");
	FileLogger.log(path, params);
    ...
    String success_details = RequestUtil.getParameter(request, "success_details");

	//批量付款数据中转账失败的详细信息
    //String fail_details = new String(request.getParameter("fail_details").getBytes("ISO-8859-1"),"UTF-8");
    String fail_details = RequestUtil.getParameter(request, "fail_details");
