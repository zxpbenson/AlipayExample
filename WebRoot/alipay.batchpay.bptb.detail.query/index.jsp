...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝批量付款到银行账户-明细查询接口快速通道</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDfile_name" />
						<span>必填，含扩展名，如：20120711.csv</span>
					</dd>
					<dt>商户流水号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDserial_no" />
						<span>如果该值存在，则status、bank_account_no 两个查询条件无效</span>
					</dd>
					<dt>代发明细状态：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDstatus" />
						<span>取值参见接口技术文档</span>
					</dd>
					<dt>收款人银行账号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDbank_account_no" />
						<span>商户上传代发文件中的收款人银行账号</span>
					</dd>
                    <dt></dt>
                    <dd>
